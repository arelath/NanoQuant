...
from nanoquant.recipes import EXPERIMENT_008_CONFIG, EXPERIMENT_013_CONFIG
...
def test_008_and_013_numbered_runfiles_import_the_canonical_recipe_objects() -> None:
    cases = (
        (
