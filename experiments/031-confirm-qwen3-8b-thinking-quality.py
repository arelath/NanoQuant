...
EXPERIMENT = define_compression_quality_experiment(
    ExperimentIdentity(
        ...
        purpose=(
            "Confirm Experiment 030's teacher-generated thinking and non-thinking data recipe "
            "on the pinned Qwen3 8B model with deployment-authoritative serial llama.cpp scoring."
        ),
        hypothesis=(
            "The teacher-coherent dual-mode recipe scales to Qwen3 8B at the retained bit budget "
            "and passes independent thinking, non-thinking, generic-quality, artifact, memory, "
            "and resume gates without changing the source chat-template default."
        ),
    ...
    export=CompressionExportPolicy(
        release_name="qwen3-8b-teacher-dual-mode-exp031",
        runtime_family="qwen",
    ),
)
