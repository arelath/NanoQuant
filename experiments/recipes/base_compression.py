...
_QWEN_LLAMACPP_TEACHER_TRACE_SLICES = tuple(
    item
    if item.teacher_trace_generation is None
    else replace(
        item,
    ...
    for item in _QWEN_TEACHER_TRACE_SLICES
)

QWEN_3_0_6B_LLAMACPP_TEACHER_TRACE_COMPRESSION_TEMPLATE = config_delta(
    QWEN_3_0_6B_TEACHER_TRACE_COMPRESSION_TEMPLATE,
    dataset=config_delta(
        QWEN_3_0_6B_TEACHER_TRACE_COMPRESSION_TEMPLATE.dataset,
        formatting="qwen3-ultrachat-llamacpp-teacher-traces-v1",
        behavior_slices=_QWEN_LLAMACPP_TEACHER_TRACE_SLICES,
    ),
)

QWEN_3_8B_LLAMACPP_TEACHER_TRACE_COMPRESSION_TEMPLATE = config_delta(
    QWEN_3_0_6B_LLAMACPP_TEACHER_TRACE_COMPRESSION_TEMPLATE,
    model=QWEN_3_8B_COMPRESSION_TEMPLATE.model,
    evaluation=QWEN_3_8B_DUAL_MODE_COMPRESSION_TEMPLATE.evaluation,
)
...
_INTERACTIVE_TEMPLATES = {
    "Qwen/Qwen3-0.6B": QWEN_3_0_6B_LLAMACPP_TEACHER_TRACE_COMPRESSION_TEMPLATE,
...
__all__ = [
    ...
    "QWEN_3_8B_LLAMACPP_TEACHER_TRACE_COMPRESSION_TEMPLATE",
    "QWEN_3_8B_TEACHER_TRACE_COMPRESSION_TEMPLATE",
