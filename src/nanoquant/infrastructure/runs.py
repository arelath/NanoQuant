...
def launcher_provenance(
    ...
    if experiment_number is None and launcher.name == "compress_model.py":
        launcher_kind = "interactive"
    elif experiment_number is not None and launcher.suffix.lower() in {".yaml", ".yml", ".json"}:
