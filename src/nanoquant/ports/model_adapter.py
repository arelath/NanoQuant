...
from nanoquant.domain.models import BlockId, BlockInventory, LayerId, ModelInventory, SharedInputGroupCandidate
...
class ModelAdapter(Protocol):
    ...
    def run_decoder_forward(self, model: nn.Module, tokens: Tensor) -> object: ...
    def run_full_forward(self, model: nn.Module, tokens: Tensor) -> Tensor: ...
