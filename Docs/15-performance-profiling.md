...
Resident causal, block, and streamed calibration now expose opt-in micro phases for forward execution, loss
...
Frozen-run assembly and resident layer replay now expose inventory/journal reads, commit validation, model loading,
